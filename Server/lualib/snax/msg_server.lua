...
function server.sendmessage(username, msg)
	local u = user_online[username]
	return u and u.fd and pcall(socketdriver.send(u.fd, netpack.pack(msg)))
end
...
function server.start(conf)
	...
	local function do_request(fd, message)
		...
		conf.request_handler(u.username, message)
	end
