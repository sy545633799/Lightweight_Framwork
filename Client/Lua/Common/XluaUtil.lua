...
XluaUtil = {}
function XluaUtil.async_to_sync(async_func, callback_pos)
    return function(...)
...
function XluaUtil.coroutine_call(func)
    return function(...)
...
function XluaUtil.cs_generator(func, ...)
    local params = {...}
...
function XluaUtil.hotfix_ex(cs, field, func)
...
function XluaUtil.bind(func, obj)
    return function(...)
        return func(obj, ...)
    end
end
...
function XluaUtil.createdelegate(delegate_cls, obj, impl_cls, method_name, parameter_type_list)
...
function XluaUtil.state(csobj, state)
...
function XluaUtil.print_func_ref_by_csharp()
