...
#define _USE_OUTPUT_COLOR 1
	...
	#define _USE_TEXCOORD2
#endif

#if defined(_SOFTPARTICLES_ON) || defined(_FADING_ON) || defined(_DISTORTION_ON)
	#define _USE_TEXCOORD3
#endif
...
#if defined(_SOFTPARTICLES_ON) || defined(_FADING_ON) || defined(_DISTORTION_ON)
	o.texcoord3 = ComputeScreenPos(vertexInput.positionCS);
#endif
...
#if defined(_SOFTPARTICLES_ON) || defined(_FADING_ON) || defined(_DISTORTION_ON)
	projectedPosition = i.texcoord3;
#endif

	half4 albedo = SampleAlbedo(uv, blendUv, _BaseColor, i.color, projectedPosition, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
