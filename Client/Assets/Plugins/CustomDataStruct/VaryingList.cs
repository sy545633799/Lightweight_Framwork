...
//{
	...
	public abstract class VaryingList<T> : BufferedList<T>
	{
		...
		public VaryingList(int capacity = 0) : base(capacity) { }
		...
		public unsafe void CallArrayWithLength(int length, ArrayAction action)
		{
		...
		{
#if !UNITY_WEBPLAYER
			CallArrayWithLength(size, action);
#else
	...
	{
		public VaryingIntList(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
	...
	{
		public VaryingVector2List(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
		public override unsafe void* GetBufferPointer()
		{
			fixed (void* pBuffer = buffer)
	...
	{
		public VaryingVector3List(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
		public override unsafe void* GetBufferPointer()
		{
			fixed (void* pBuffer = buffer)
	...
	{
		public VaryingVector4List(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
		public override unsafe void* GetBufferPointer()
		{
			fixed (void* pBuffer = buffer)
	...
	{
		public VaryingColor32List(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
		public override unsafe void* GetBufferPointer()
		{
			fixed (void* pBuffer = buffer)
	...
	{
		public VaryingColorList(int capacity = 0) : base(capacity) { }
#if !UNITY_WEBPLAYER
		public override unsafe void* GetBufferPointer()
		{
			fixed (void* pBuffer = buffer)
