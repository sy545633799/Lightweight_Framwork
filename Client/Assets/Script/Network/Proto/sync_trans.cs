...
namespace Game {
	public class sync_trans : SprotoTypeBase
	{
		...
		public sync_trans() : base(max_field_count) { }

		public sync_trans(byte[] buffer) : base(max_field_count, buffer)
		{
			this.decode();
		}
