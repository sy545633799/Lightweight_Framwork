...
namespace XLua.CSObjectWrap
{
    ...
    public class GameLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.LuaBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.LuaBehaviour gen_ret = new Game.LuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.LuaBehaviour constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                Game.LuaBehaviour gen_to_be_invoked = (Game.LuaBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                Game.LuaBehaviour gen_to_be_invoked = (Game.LuaBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (Game.Injection[])translator.GetObject(L, 2, typeof(Game.Injection[]));
