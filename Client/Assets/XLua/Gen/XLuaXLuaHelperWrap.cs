...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaXLuaHelperWrap 
    {
        ...
        {
            return LuaAPI.luaL_error(L, "XLua.XLuaHelper does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    ...
                    int _itemCount = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        System.Array gen_ret = XLua.XLuaHelper.CreateArrayInstance( _itemType, _itemCount );
		    ...
		    try {
                ...
                
                {
                    System.Type _itemType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        System.Collections.IList gen_ret = XLua.XLuaHelper.CreateListInstance( _itemType );
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _valueType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        System.Collections.IDictionary gen_ret = XLua.XLuaHelper.CreateDictionaryInstance( _keyType, _valueType );
                        translator.PushAny(L, gen_ret);
        ...
        static int _m_CreateActionDelegate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count >= 2&& translator.Assignable<System.Type>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 3) || translator.Assignable<System.Type>(L, 3))) 
                {
                    ...
                    System.Type[] _paramTypes = translator.GetParams<System.Type>(L, 3);
                        ...
                        System.Delegate gen_ret = XLua.XLuaHelper.CreateActionDelegate( _type, _methodName, _paramTypes );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count >= 2&& translator.Assignable<object>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 3) || translator.Assignable<System.Type>(L, 3))) 
                {
                    ...
                    System.Type[] _paramTypes = translator.GetParams<System.Type>(L, 3);
                        ...
                        System.Delegate gen_ret = XLua.XLuaHelper.CreateActionDelegate( _target, _methodName, _paramTypes );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLua.XLuaHelper.CreateActionDelegate!");
		    ...
		    try {
                ...
                
                {
                    System.Type _itemType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        System.Type gen_ret = XLua.XLuaHelper.MakeGenericListType( _itemType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _valueType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        System.Type gen_ret = XLua.XLuaHelper.MakeGenericDictionaryType( _keyType, _valueType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type[] _paramTypes = translator.GetParams<System.Type>(L, 1);
                        ...
                        System.Type gen_ret = XLua.XLuaHelper.MakeGenericActionType( _paramTypes );
                        translator.Push(L, gen_ret);
